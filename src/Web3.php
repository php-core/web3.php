    ...
    public function __call($name, $arguments)
    {
        ...
        if (preg_match('/^[a-zA-Z0-9]+$/', $name) === 1) {
            ...
            if (!array_key_exists($method, $this->methods)) {
                // new the method
                $methodClass = sprintf("\PHPCore\Methods\%s\%s", ucfirst($class[1]), ucfirst($name));
