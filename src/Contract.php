...
use PHPCore\Providers\Provider;
use PHPCore\Providers\HttpProvider;
use PHPCore\Providers\WsProvider;
use PHPCore\Utils;
use PHPCore\Eth;
use PHPCore\Contracts\Ethabi;
use PHPCore\Contracts\Types\Address;
use PHPCore\Contracts\Types\Boolean;
use PHPCore\Contracts\Types\Bytes;
use PHPCore\Contracts\Types\DynamicBytes;
use PHPCore\Contracts\Types\Integer;
use PHPCore\Contracts\Types\Str;
use PHPCore\Contracts\Types\Uinteger;
...
class Contract
{
     ...
     * provider
     *
     * @var \PHPCore\Providers\Provider
     */
    protected $provider;
     ...
     * construct
     *
     * @param string|\PHPCore\Providers\Provider $provider
     ...
     * getProvider
     * 
     * @return \PHPCore\Providers\Provider
     */
     ...
     * setProvider
     *
     * @param \PHPCore\Providers\Provider $provider
     * @return $this
     */
